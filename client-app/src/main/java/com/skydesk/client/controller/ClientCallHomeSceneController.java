...
public class ClientCallHomeSceneController {
    ...
    public void btnConnectOnAction(ActionEvent actionEvent) throws IOException {
        ...
        if (userName.equals("d")) ipAddress = "127.0.0.5";

        System.out.println(userName);
        if (ipAddress != null) {
            try {
                // Load the new scene
                Parent secondaryRoot = FXMLLoader.load(getClass().getResource("/scene/ClientVideoSence.fxml"));

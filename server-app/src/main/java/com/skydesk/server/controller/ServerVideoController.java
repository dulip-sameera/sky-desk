...
public class ServerVideoController {
...
//    192.168.43.74
        ...
        while (isServerRunning) {
            ...
            new Thread(() -> {
                try {
                    ...
                    System.out.println("Sending response from server side");
    ...
    public void btnCutOnAction(ActionEvent actionEvent) {
        ...
        try {
            // Load the new scene
            Parent secondaryRoot = FXMLLoader.load(getClass().getResource("/scene/ServerCallHomeScene.fxml"));
